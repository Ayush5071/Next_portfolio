...
export const Experiences = [
  {
    ...
    detailedDesc: "Developed Cipher — a full-featured payroll management system. Built the complete frontend in Next.js and backend APIs with Express + MongoDB. Implemented employee management, salary processing, attendance tracking, and financial reporting modules.",
    skills: ["Next.js", "Express", "MongoDB", "Tailwind CSS", "Node.js"],
    github: "#",
    linkedin: "#",
    video: "",
