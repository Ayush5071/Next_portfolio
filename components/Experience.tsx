...
import { FaGithub, FaLinkedin, FaBriefcase, FaExternalLinkAlt } from "react-icons/fa";
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className="flex items-start justify-between mb-6">
                      <div className={`p-3 rounded-2xl bg-gradient-to-br ${accent.bg} border ${accent.border}`}>
                        <FaBriefcase className={`text-2xl ${accent.icon}`} />
                      </div>
                      <div className="flex gap-3">
                        ...
                        {experience.linkedin && experience.linkedin !== "#" && (
                          <motion.a
