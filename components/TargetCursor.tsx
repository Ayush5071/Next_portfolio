  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      ...
      corners.forEach((corner, i) => {
        ...
        const targetX = Number(targetCornerPositionsRef.current[i].x) - cursorX;
        const targetY = Number(targetCornerPositionsRef.current[i].y) - cursorY;
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      corners.forEach((corner, i) => {
        gsap.to(corner, {
          x: Number(targetCornerPositionsRef.current[i].x) - Number(cursorX),
          y: Number(targetCornerPositionsRef.current[i].y) - Number(cursorY),
          duration: 0.2,
          ease: 'power2.out'
        });
      });
